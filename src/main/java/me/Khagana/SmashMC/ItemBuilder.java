...
public class ItemBuilder {
    ...
    public boolean equals(Object o) {
        ...
        return amount == that.amount && damage == that.damage && andSymbol == that.andSymbol && unsafeStackSize == that.unsafeStackSize && Objects.equals(item, that.item) && Objects.equals(meta, that.meta) && material == that.material && Objects.equals(data, that.data) && Objects.equals(enchantments, that.enchantments) && Objects.equals(displayname, that.displayname) && Objects.equals(lore, that.lore) && Objects.equals(flags, that.flags);
    }

    @Override
    public int hashCode() {
        return Objects.hash(item, meta, material, amount, data, damage, enchantments, displayname, lore, flags, andSymbol, unsafeStackSize);
    }
